...
const ROUTES = [
  ["home", "/"],
  ["catalog", "/catalog"],
  ["catalog-culture", "/catalog/malina-remontantnaya"],
  ["catalog-filtered", "/catalog/malina-remontantnaya?kind=Бесшипная&hardiness=25"],
  ["product", "/product/smorodina-zks-titaniya"],
  ["product-preorder", "/product/golubika-blyukrop"],
  ["product-out", "/product/klubnika-frigo-kleri"],
  ["cart", "/cart"],
  ["checkout", "/checkout"],
  ["favorites", "/favorites"],
  ["account", "/account"],
  ["search", "/search?q=ремонтантная"],
  ["collection", "/collection/malina-na-vsyo-leto"],
  ["article", "/care/obrezka-remontantnoy-maliny"],
  ["compare", "/compare?items=malina-remontantnaya-karamelka,malina-remontantnaya-polka,malina-letnyaya-glen-ampl"],
  ["sale", "/sale"],
  ["delivery", "/delivery"],
  ["guarantee", "/guarantee"],
  ["care", "/care"],
