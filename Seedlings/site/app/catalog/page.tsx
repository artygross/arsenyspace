...
export const metadata: Metadata = {
  ...
  description:
    "Саженцы и рассада из собственного питомника: смородина ЗКС, малина ремонтантная и летняя, клубника ЗКС и фриго, ежевика, голубика. Фильтры по сроку созревания, зимостойкости и фасовке.",
};
