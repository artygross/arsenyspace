        ...
        <div className="bg-sand grid gap-6 rounded-[28px] p-6 lg:grid-cols-[1fr_auto] lg:items-center lg:p-10">
          <div>
            ...
            <p className="text-ink-muted mt-4 max-w-2xl leading-relaxed">
              Питомник работает круглосуточно, приезжать можно в любое время — предупредите заранее,
              и заказ соберут к вашему появлению. На месте можно выбрать конкретные экземпляры
              и посмотреть корневую систему до оплаты.
            </p>
          </div>
