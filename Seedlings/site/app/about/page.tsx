...
export const metadata: Metadata = {
  title: "О питомнике",
  description:
    "Питомник «Своя грядка»: 12 лет, 240 сортов, 18 000 заказов. Выращиваем рассаду и саженцы сами, продаём напрямую садоводам, отдаём на самовывоз в Тульской области.",
};
