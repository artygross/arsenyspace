...
export const metadata: Metadata = {
  ...
  description:
    "Календарь посадки по месяцам и практические инструкции: когда сажать клубнику, как обрезать ремонтантную малину, зачем жимолости опылитель.",
};

const CALENDAR = [
  { month: 3, what: "Посев овощной и цветочной рассады, досветка, пикировка" },
  ...
  { month: 6, what: "Полив и мульчирование, сбор жимолости и ранней клубники" },
  ...
  { month: 9, what: "Осенняя посадка кустарников: малина, смородина, крыжовник" },
